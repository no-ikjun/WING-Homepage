      ...
      <div className={styles.container}>
        ...
        <div className={styles.sessions}>
          ...
          <div className={[styles.sessions_div, styles.intro_text, styles.intro_right].join(" ")} style={{ width: "65%" }}>
            ...
            <p className={styles.sessions_content}>
              WING 세션은 개발에 관심있는 모두에게 열려있습니다. WING 세션에 참여하고 싶다면, 게시판에 공지된 포스터를 참고하여 시간에 맞게 해동학술정보실로 오시면 됩니다. 세션 도중에 자유롭게
              들어오셔도 되고, 듣다가 자유롭게 나가셔도 좋습니다.
            </p>
            <p className={styles.sessions_content}>또한 WING 소속이 아니더라도, 세션을 진행해볼 수 있습니다. 아래 링크를 클릭하시면 세션 진행을 위한 신청서를 작성하실 수 있습니다.</p>
          </div>
        </div>
      </div>
    </div>
